...
// BUGGY
require('util').inherits(module.exports.InstructionError, Error);
require('util').inherits(module.exports.MissingPropertyError, Error);
require('util').inherits(module.exports.EmptyArrayError, Error);
require('util').inherits(module.exports.EmptyStringError, Error);
require('util').inherits(module.exports.PropertyConflictError, Error);
